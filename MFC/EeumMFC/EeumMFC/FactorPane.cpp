...
IMPLEMENT_DYNAMIC(CFactorPane, CDockablePane)
...
int CFactorPane::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
void CFactorPane::OnSize(UINT nType, int cx, int cy)
{
    CDockablePane::OnSize(nType, cx, cy);
    AdjustLayout();
}

void CFactorPane::AdjustLayout()
{
...
void CFactorPane::SetDouble(const CString& name, double v)
{
